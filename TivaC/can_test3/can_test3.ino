 ...
 */
  for (int i = 0; i < 100; i++){
    // motion_mode_command(int8_t ID, float p_des_deg, float v_des_deg_per_s, float kp, float kd, float t_ff, bool show)
      motion_mode_command(3,angle_sim_ankle[i],0,1.1,0,0,true);
      delayMS(100);
   }
}
